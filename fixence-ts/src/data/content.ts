...
export const content: Record<"fa" | "en", SiteContent> = {
  fa: {
    ...
    contact: {
      ...
      form: {
        ...
        phone: "شماره تماس",
        phonePlaceholder: "۰۹۱۲ ۱۲۳ ۴۵۶۷۹",
    ...
    footer: {
      ...
      copyright: "(علی محمدی) © ۲۰۲۶ فیکسنس ",
  ...
  en: {
    ...
    phone: { display: "0915-4025033", tel: "0915 402 50 33" },
    socials: {
      instagram: "https://instagram.com/Mostafa.ghabel",
      telegram: "https://t.me/@Mostafaghabel3",
      whatsapp: "https://wa.me/09154025033",
      youtube: "https://youtube.com/@YOUR_CHANNEL",
      linkedin: "https://linkedin.com/company/YOUR_COMPANY",
    },
    nav: {
    ...
    footer: {
      ...
      followUs: "Follow Us",
      copyright: "© 2026 Fixence (Ali Mohammadi)",
